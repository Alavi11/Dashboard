...
const overviewData = [
	{ name: "درآمد", value: "234,56700ریال", change: 12.5, icon: DollarSign },
	{ name: "کاربران", value: "45,678", change: 8.3, icon: Users },
	{ name: "سفارشات", value: "9,876", change: -3.2, icon: ShoppingBag },
	{ name: "بازدید", value: "1,234,567", change: 15.7, icon: Eye },
];
          ...
          '
            ...
            `}
					>
						...
						<span className='ml-2 text-sm text-gray-400'>نسبت به نقطه قبل</span>
					</div>
				</motion.div>
			))}
		</div>
